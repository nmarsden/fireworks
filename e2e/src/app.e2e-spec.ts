...
import { InGameMenuModalPO } from './inGameMenuModal.po';
import { QuitGameModalPO } from './quitGameModal.po';
...
describe('Fireworks App', () => {
  ...
  let inGameMenuModalPO: InGameMenuModalPO;
  let quitGameModalPO: QuitGameModalPO;
  ...
  beforeAll(() => {
    ...
    inGameMenuModalPO = new InGameMenuModalPO();
    quitGameModalPO = new QuitGameModalPO();
  ...
  describe('Main menu', () => {
    ...
    it('should open main menu modal', () => {
      expect(mainMenuModalPO.isOpen()).toBeTruthy();
    });
  ...
  describe('In game menu', () => {
    beforeAll(() => {
      appPO.navigateToNewGame();
    });

    beforeAll(() => {
      boardPO.clickMenuButton();
    });

    it('should show in game menu modal', () => {
      expect(inGameMenuModalPO.isOpen()).toBeTruthy();
    });

    it('should display quit button', () => {
      expect(inGameMenuModalPO.getQuitButton().getText()).toEqual('Quit');
    });

    it('should display continue button', () => {
      expect(inGameMenuModalPO.getContinueButton().getText()).toEqual('Continue');
    });

    describe('Click continue button', () => {
      beforeAll(() => {
        inGameMenuModalPO.getContinueButton().click();
      });

      it('should close in game menu modal', () => {
        expect(inGameMenuModalPO.isOpen()).toBeFalsy();
      });
    });

    describe('Click quit button', () => {
      beforeAll(() => {
        boardPO.clickMenuButton();
        inGameMenuModalPO.getQuitButton().click();
      });
      ...
      it('should open quit game modal', () => {
        expect(quitGameModalPO.isOpen()).toBeTruthy();
      });

      it('should display heading: Quit?', () => {
        expect(quitGameModalPO.getHeadingText()).toEqual('Quit?');
      });

      it('should display yes button', () => {
        expect(quitGameModalPO.getYesButton().getText()).toEqual('Yes');
      });

      it('should display no button', () => {
        expect(quitGameModalPO.getNoButton().getText()).toEqual('No');
      });

      describe('Click no button', () => {
        beforeAll(() => {
          quitGameModalPO.getNoButton().click();
        });

        it('should close quit game modal', () => {
          expect(quitGameModalPO.isOpen()).toBeFalsy();
        });
      });

      describe('Click yes button', () => {
        beforeAll(() => {
          boardPO.clickMenuButton();
          inGameMenuModalPO.getQuitButton().click();
          quitGameModalPO.getYesButton().click();
        });
  ...
  describe('Game State: New game with first tile marked as SAVE', () => {

    beforeAll(() => {
      appPO.navigateToNewGameWithFirstTileMarkedAsSave();
    });
    ...
    describe('Initial State', () => {
      ...
      it('should have player tile marks', () => {
        expect(boardPO.getPlayerTileMarks()).toEqual(['save', 'none', 'none', 'none', 'none']);
      });

      describe('Drag left most player tile to far right: BLUE 2 dragged to RAINBOW 4', () => {
        beforeAll(() => {
          boardPO.dragAndDropPlayerTile(0, 4);
        });

        it('should have dragged player tile: BLUE 4, GREEN 5, GREEN 1, RAINBOW 4, BLUE 2,', () => {
          expect(boardPO.getPlayerTiles()).toEqual([
            'colour:blue, number:4',
            'colour:green, number:5',
            'colour:green, number:1',
        ...
        it('should have player tile marks', () => {
          expect(boardPO.getPlayerTileMarks()).toEqual(['none', 'none', 'none', 'none', 'save']);
        });
      });
    });
  });

  describe('Game State: New game with first tile marked as SAVE - 2', () => {
    ...
    describe('Initial State', () => {
      ...
      describe('Click and Slow Drag left most player tile to far right: BLUE 2 dragged to RAINBOW 4', () => {
        beforeAll(() => {
          boardPO.clickAndSlowDragAndDropPlayerTile(0, 4);
        });

        it('should not show marking modal', () => {
          expect(markingModalPO.isOpen()).toBeFalsy();
        });
  ...
  describe('Game State: New game with first tile marked as SAVE - 3', () => {
    ...
    describe('Initial State', () => {
      ...
      describe('Click and Hold and Drag left most player tile to far right: BLUE 2 dragged to RAINBOW 4', () => {
        beforeAll(() => {
          boardPO.clickAndHoldAndDragAndDropPlayerTile(0, 4);
        });
        ...
        it('should not have dragged player tile: BLUE 2, BLUE 4, GREEN 5, GREEN 1, RAINBOW 4', () => {
          expect(boardPO.getPlayerTiles()).toEqual([
            'colour:blue, number:2',
            'colour:blue, number:4',
            'colour:green, number:5',
